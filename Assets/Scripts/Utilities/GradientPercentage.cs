...
public class GradientPercentage : BaseMeshEffect
{
    ...
    [Range(-0.6f, 0.8f)] public float Offset = 0.1f;
    ...
    public override void ModifyMesh(VertexHelper vh)
    {
        if (enabled)
        {
            ...
            for (var i = 0; i < vh.currentVertCount; i++)
            {
                ...
                var localPosition = localPositionMatrix * vertex.position + Offset * Vector2.one;
    ...
    public void UpdateOffset(float percentageLeft)
    {
        Offset = 0.1f + percentageLeft * 0.7f;
    }
